  ...
  private EventHandler<TestStepStarted> eventHandlerTestStepStarted = new EventHandler<TestStepStarted>() {
    public void receive(TestStepStarted event) {
      if (event.getTestStep() instanceof PickleStepTestStep) {
        ...
        String testStepKeyWord = ((PickleStepTestStep) event.getTestStep()).getStep().getKeyword();
        ExtentTest extentTest = extentTestThreadLocalTestCase.get().createNode(testStepKeyWord+" "+testStepName);
